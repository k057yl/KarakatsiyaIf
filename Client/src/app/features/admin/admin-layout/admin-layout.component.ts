  ...
  template: `
    <div class="admin-layout">
      ...
      <div class="admin-tabs">
        ...
        <a routerLink="/admin/categories" routerLinkActive="active" class="tab-link">📂 Категории афиши</a>
        <a routerLink="/admin/performers" routerLinkActive="active" class="tab-link">🎸 Модерация артистов</a>
      </div>
